     ...
     return(
       <div className="tab-content">
       {
         this.props.tabContents.map((content, index) =>{
           ...
           return(
              <div key={index} role="tabpanel" className={cls} dangerouslySetInnerHTML={{ __html: content}}>
                ...
                this.props.menus.map((menu, index) => {
                  ...
                  return(
                    <li key={index} role="presentation" className={cls}>
                      <a onClick={this.onTabClick.bind(this , index)} aria-controls={menu.name} role="tab" data-toggle="tab">
